 ...
 */
@ApiMayChange
final class SourceWithContext[+Ctx, +Out, +Mat] private[stream] (delegate: Source[(Out, Ctx), Mat])
  ...
  override def viaMat[Ctx2, Out2, Mat2, Mat3](flow: Graph[FlowShape[(Out, Ctx), (Out2, Ctx2)], Mat2])(
