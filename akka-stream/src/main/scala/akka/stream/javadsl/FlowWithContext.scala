...
object FlowWithContext {
  ...
  def fromPairs[CtxIn, In, CtxOut, Out, Mat](
      under: Flow[Pair[In, CtxIn], Pair[Out, CtxOut], Mat]): FlowWithContext[CtxIn, In, CtxOut, Out, Mat] = {
    new FlowWithContext(
...
final class FlowWithContext[-CtxIn, -In, +CtxOut, +Out, +Mat](
   ...
   */
  def grouped(n: Int): FlowWithContext[CtxIn,
                                       In,
   ...
   */
  def mapConcat[Out2](
      f: function.Function[Out, _ <: java.lang.Iterable[Out2]]): FlowWithContext[CtxIn, In, CtxOut, Out2, Mat] =
  ...
  def mapContext[CtxOut2](
      extractContext: function.Function[CtxOut, CtxOut2]): FlowWithContext[CtxIn, In, CtxOut2, Out, Mat] = {
   ...
   */
  def sliding(n: Int, step: Int = 1): FlowWithContext[CtxIn,
                                                      In,
                                                      java.util.List[CtxOut @uncheckedVariance],
                                                      java.util.List[Out @uncheckedVariance],
                                                      Mat] =
